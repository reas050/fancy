...
tl.to('.title-1 .letter', { opacity: 1, y: '0', clipPath: 'polygon(0 0, 100% 100%, 0 100%)', stagger: '.03'})
tl.to('.title-2 .letter', { opacity: 1, y: '0', clipPath: 'polygon(0 0, 100% 100%, 0 100%)', stagger: '.03'}, "-=.7")
tl.to('.title-3 .letter', { opacity: 1, y: '0', clipPath: 'polygon(0 0, 100% 100%, 0 100%)', stagger: '.03'}, "-=.7")
